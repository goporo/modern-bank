    ...
    return (
        <section id='product' className={layout.sectionReverse}>
            ...
            <div className={layout.sectionInfo}>
                ...
                <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Elit enim sed massa etiam. Maurius aenean adipiscing ultrices ametodio aenean neque. Fusce ipsum orci rhoncus aliporttitor integer latea placerat</p>
